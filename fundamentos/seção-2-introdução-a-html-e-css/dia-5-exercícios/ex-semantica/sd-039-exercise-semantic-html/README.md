...
- Use o comando: `git clone git@github.com:tryber/sd-039-exercise-semantic-html.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-039-exercise-semantic-html`
...
- Verifique que você está na raiz do projeto:
  - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/maria/code/**sd-039-exercise-semantic-html**_
...
- Vá até a página de *Pull Requests* do [repositório no GitHub](https://github.com/tryber/sd-039-exercise-semantic-html/pulls)
...
- Volte até a [página de *Pull Requests* do repositório](https://github.com/tryber/sd-039-exercise-semantic-html/pulls) e confira que o seu *Pull Request* está criado
